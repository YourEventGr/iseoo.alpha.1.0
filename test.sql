...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 13, 2017 at 01:16 AM
...
(4, 'Penyewaan Gedung ABC', '123123', '12901290129', '2', 'Cocok untuk event seminar, Promosi dan kegiatan pendidikan', 'seminar', 'dzz', '1');
...
INSERT INTO `sponsor` (`id`, `nama_sponsor`, `kontak`, `jenis_sponsor`, `deskripsi`, `untuk_event`, `pemilik`, `status`) VALUES
(2, 'iseoo.id', '081210113977', 'partisipan', 'startup teknologi', 'all event', 'dzz', '1');
