                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <ul class="breadcrumb">
                            ...
                            <li><a href="Kebutuhan-Genneo.html">Kebutuhan-YOT</a></li>
                            <li>Venue</li>
                        </ul>
 ...
 _________________________________________________________ -->
                        <div class="panel panel-default sidebar-menu">
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title">Jenis Venue</h3>
                            </div>

                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked category-menu">
                                    <li>
                                        <a href="shop-category.html">Digital <span class="badge pull-right">42</span></a>

                                    </li>
                                    <li class="active">
                                        <a href="shop-category.html">Furniture  <span class="badge pull-right">123</span></a>
			...
			_________________________________________________________ -->
                    ...
                    <div class="col-sm-9">
                            ...
                            <div class="col-md-4 col-sm-6 blogBox moreBox">
                                <div class="product">
                                    <div class="image">
                                        <a href="detail-alat-meja.html">
                                            <img src="img/product1.jpg" alt="" class="img-responsive image1">
                                        </a>
                                    </div>
                                    <!-- /.image -->
                                    <div class="text">
                                        <h3><a href="detail-alat-meja.html">Fur coat with very but very very long name</a></h3>
