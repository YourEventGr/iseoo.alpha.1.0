...
<!--- sampai sini -->
 ...
 <li class="dropdown">
    <a href="#" class="dropdown-toggle profile-image" data-toggle="dropdown">
    <img src="http://placehold.it/30x30" class="img-circle special-img"> <label style="font-size:12px; text-transform: none;"> Nama akun </label><b class="caret"></b></a>
                <ul class="dropdown-menu ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <ul class="breadcrumb">
                            ...
                            <li><a href="Kebutuhan-YOT.html">Kebutuhan-Genneo</a></li>
                            <li>Ambil Peralatan</li>
                        </ul>
 ...
 _________________________________________________________ -->
                        <div class="panel panel-default sidebar-menu">
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title">Jenis Alat</h3>
                            </div>

                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked category-menu">
                                    <li>
                                        <a href="shop-category.html">Olahraga <span class="badge pull-right">42</span></a>
                                        
                                    </li>
                                    <li class="active">
                                        <a href="shop-category.html">Talkshow  <span class="badge pull-right">123</span></a>
                                        
                                    </li>
                                   
<li >
                                        <a href="shop-category.html">Musik  <span class="badge pull-right">123</span></a>
                                        
                                    </li>


                                    <li >
                                        <a href="shop-category.html">Company <span class="badge pull-right">123</span></a>
                                        
                                    </li>
                                    <li >
                                        <a href="shop-category.html">Wedding  <span class="badge pull-right">123</span></a>
			...
			_________________________________________________________ -->
                    ...
                    <div class="col-sm-9">
                            ...
                            <div class="col-md-4 col-sm-6 blogBox moreBox">
                                <div class="product">
                                    <div class="image">
                            ...
                            <div class="col-md-4 col-sm-6 blogBox moreBox" style="display: none;" >
                                <div class="product">
                                    <div class="image">
                                        <a href="shop-detail.html">
                                            <img src="img/product1.jpg" alt="" class="img-responsive image1">
