                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <ul class="breadcrumb">
                            ...
                            <li><a href="portfolio-2.html"><?= $obj->nama_event;?></a>
                            </li>
...
<div class="row portfolio-project">
                    ...
                    <section>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="heading">
                                <h3>Kebutuhan yang sudah ditambahkan</h3>
                            </div>

                            <?php
                            $url2 = file_get_contents("http://localhost/iseoo_api/current-order-detail.php?eid=".$_GET['eid']);
$get_json2 = json_decode($url2);
foreach($get_json2->return as $index=>$obj2){
if($obj2->statusJson == 1){
    ?>
                            <p><?= $obj2->nama_jasa;?> (<?= $obj2->status;?>)</p>
                            <?php 
                            }else{
                            ?>

                            <p>Belum ada daftar kebutuhan</p>
                            <?php }}?>
                        </div>
                    </section>
