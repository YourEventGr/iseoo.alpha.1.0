...
_________________________________________________________ -->
        ...
        <div id="content">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p class="text-muted lead">tersedia 2 barang untuk dijual.</p>
                    </div>
                        ...
                        <div class="box">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="daftar-transaksi-speaker.html">Speaker</a>
                                                </td>
                                                  <td><a href="detail-alat-Speaker.html"><i class="fa fa-info"></i></a>
                                                </td>
                                                 <td><a  href="#ubahModal" data-toggle="modal" ><i class="fa fa-pencil"></i></a>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="#">
                                                        <img src="img/portfolio-2.jpg" alt="Black Blouse Armani">
                                                    </a>
                                                </td>
                                                <td><a href="daftar-transaksi-meja.html">Meja</a>
                                                </td>
                                               
                                                  <td><a href="detail-alat-meja.html"><i class="fa fa-info"></i></a>
                                                </td>
                                                 <td><a href="#ubahModal" data-toggle="modal" ><i class="fa fa-pencil"></i></a>
                                                </td>
                                                <td><a href="#"><i class="fa fa-trash-o"></i></a>
                                ...
                                <div class="box-footer">
                                    ...
                                    <div class="pull-right">
                                        ...
                                        <button type="submit"  data-toggle="modal" data-target="#squarespaceModal"  class="btn btn-template-main"><i class="fa fa-plus">Tambah Layanan </i>
                                        </button>
                                    </div>
                                </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h3 class="modal-title" id="lineModalLabel">Tambah Layanan</h3>
        </div>
        <div class="modal-body">
            ...
            <form>
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukan nama layanan">
              </div>

               <div class="form-group">
                <label  for="jenis_event">Jenis Layanan</label>
