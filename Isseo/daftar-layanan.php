...
$url = file_get_contents("http://localhost/iseoo_api/current-event-detail.php?eid=".$_GET['eid']);
 ...
 _________________________________________________________ -->
                        ...
                        <div class="panel panel-default sidebar-menu with-icons">
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title">Daftar Kebutuhan</h3>
                            </div>

                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    <li class="active"><a href="#tab1" data-toggle="tab">Venue</a>
                                    </li>
                                    <li><a href="#tab2" data-toggle="tab">Peralatan</a>
                                    </li>
                                    <li><a href="#tab3" data-toggle="tab">Sponsor</a>
                                    </li>
                    ...
                    <div class="col-md-9">
                        <div class="tab-content" >
                            <div class="panel-group  tab-pane active" id="tab1">
                           <div class="row">
                            <?php
                             $url2 = file_get_contents("http://localhost/iseoo_api/layanan-jasa-list.php");
                             $get_json2 = json_decode($url2);
                             foreach($get_json2->return as $index=>$obj2){
                               if($obj2->jenis_jasa == '2' ){
                               ?>
                            <div class="col-md-4  blogBox1 moreBox1 " >
                                <div class="box-image-text">
                                    <div class="top">
                                        ...
                                        <div class="text">
                                            <p class="buttons">
                                                <a href="detail-jasa.php?eid=<?= $_GET['eid'];?>&jid=<?= $obj2->id ?>" class="btn btn-template-transparent-primary"><i class="fa fa-link"></i> Read more</a>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="content">
                                        <h4><a href="blog-post.html"><?= $obj2->nama_jasa?></a></h4>
                                        <p><?= $obj2->deskripsi?></p>
                                    </div>
                                </div>
                                <!-- /.box-image -->
...
<div class="text-center">
                                    <button type="submit" class="btn btn-template-main" id="loadMore"><i class="fa fa-user-md"></i> Lihat Selanjutnya</button></br></br>
                                      <!-- <button type="submit"  data-toggle="modal" data-target="#squarespaceModal" class="btn btn-template-main"><i class="fa fa-plus">Tambah Venue </i>
                                        </button> -->
                                </div>
                        </div>
  ...
  <div class="panel-group  tab-pane " id="tab2">
                           <div class="row">
                             <?php
                             $url2 = file_get_contents("http://localhost/iseoo_api/layanan-jasa-list.php");
                             $get_json2 = json_decode($url2);
                             foreach($get_json2->return as $index=>$obj2){
                               if($obj2->jenis_jasa == '1' ){
                               ?>
                            <div class="col-md-4  blogBox1 moreBox1 " >
                                <div class="box-image-text">
                                    <div class="top">
...
<div class="text-center">
                                 ...
                                 <div class="panel-group  tab-pane " id="tab3">
                           <div class="row">
                            <div class="col-md-4  blogBox3 moreBox3 " >
                                <div class="box-image-text">
                                    <div class="top">
                                        <div class="image">
                                            <img src="img/portfolio-4.jpg" alt="" class="img-responsive">
 ...
 <div class="col-md-4 blogBox3 moreBox3" style="display: none;" >
                                <div class="box-image-text">
                                    <div class="top">
                                        <div class="image">
                                            <img src="img/portfolio-6.jpg" alt="" class="img-responsive">
                        ...
                        <div class ="row">
<div class="text-center">
                                    <button type="submit" class="btn btn-template-main" id="loadMore3"><i class="fa fa-user-md"></i> Lihat Selanjutnya</button></br></br>
                                      <button type="onclick" onclick="window.location.href='daftar-sponsor-YOT.html'" class="btn btn-template-main"><i class="fa fa-plus">Tambah Sponsor </i>
                                        </button>
                                </div>
                        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h3 class="modal-title" id="lineModalLabel">Pencarian Venue</h3>
        </div>
        <div class="modal-body">
            ...
            <form>
              <div class="form-group">
                <label for="exampleInputEmail1">Nama Venue</label>
                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukan nama tempat">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukan kata kunci">
              </div>
              <div class="text-center">
              <button type="button" onclick="window.location.href='daftar-venue-YOT.html'" class="btn btn-default">Cari</button>
              </div>
            </form>
...
<div class="modal fade" id="uploadModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
            <h3 class="modal-title" id="lineModalLabel">konfirmasi pembayaran</h3>
        </div>
        <div class="modal-body">
            ...
            <form>
              <div class="form-group">
                <p>Pembayaran dapat dilakukan di rekening XXXXX-XXXX-XXXX</p>
              </div>
...
$( document ).ready(function () {
  ...
  $(".moreBox1").slice(0, 3).show();
                ...
                $("#loadMore1").on('click', function (e) {
                        e.preventDefault();
                        $(".moreBox1:hidden").slice(0, 5).slideDown();
 ...
 $(".moreBox3").slice(0, 3).show();
                ...
                $("#loadMore3").on('click', function (e) {
                        e.preventDefault();
                        $(".moreBox3:hidden").slice(0, 5).slideDown();
