                        ...
                        <div class="box">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <?php
                                        $url = file_get_contents("http://localhost/iseoo_api/current-layanan-list.php?uid=".$_SESSION['username']);
    ...
    ?>
                                            <tr>
                                                ...
                                                <td><?= $obj->status?>
                                                  ...
                                                  <td><a href="order-list.php?lid=<?=$obj->id?>"><i class="fa fa-search"></i></a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
