...
_________________________________________________________ -->
        ...
        <div id="content">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p class="text-muted lead">Daftar Tagihan Layanan IS.EO</p>
                    </div>
                        ...
                        <div class="box">
                                ...
                                <div class="table-responsive">
                                 ...
                                 <th >Jumlah Tagihan</th>
								  <th>Status</th>
                                                <th colspan="3">Upload Pembayaran</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
												...
												<td><a href="#uploadModal" data-toggle='modal'><i class="fa fa-upload" ></i></a>
                                                </td>
...
<div class="modal fade" id="uploadModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
            <h3 class="modal-title" id="lineModalLabel">Upload pembayaran</h3>
        </div>
        <div class="modal-body">
